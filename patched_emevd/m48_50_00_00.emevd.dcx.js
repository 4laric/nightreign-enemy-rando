...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 99055400, 48502200, 48500200);
        $InitializeCommonEvent(0, 99055300, 48502200, 48500200);
        $InitializeCommonEvent(0, 99055200, 48500200, 48500800, 48500810);
    }
...
$Event(48502310, Restart, function(chrEntityId, chrEntityId2, chrEntityId3, dummypolyId, spEffectId) {
    WaitFor((EventFlag(48502300) && CharacterHasSpEffect(chrEntityId, 13744)) || ElapsedSeconds(10));
...
$Event(48502320, Restart, function(spEffectId, chrEntityId, chrEntityId2, spEffectId2) {
    WaitFor((EventFlag(48502310) && CharacterHasSpEffect(chrEntityId, 13731)) || ElapsedSeconds(10));
