...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 99055400, 49192200, 49190200);
        $InitializeCommonEvent(0, 99055300, 49192200, 49190200);
        $InitializeCommonEvent(0, 99055200, 49190200, 49190800, 49190810);
    }
